package com.zb.maclearn.executor;
...
public class ThreadPoolExecutor2 extends AbstractExecutorService {
    ...
    private static final int COUNT_BITS = Integer.SIZE - 3; //Integer.SIZE = 32； 29
    private static final int CAPACITY   = (1 << COUNT_BITS) - 1; //10100000 00000000 00000000 00000000 - 1
                                                                //->1001111 11111111 11111111 11111111 高3位为状态信息，那么剩下的占满是线程容量

    // runState is stored in the high-order bits
    private static final int RUNNING    = -1 << COUNT_BITS; //001
    private static final int SHUTDOWN   =  0 << COUNT_BITS; //000
    private static final int STOP       =  1 << COUNT_BITS; //101
    private static final int TIDYING    =  2 << COUNT_BITS; //110
    private static final int TERMINATED =  3 << COUNT_BITS; //111

    // Packing and unpacking ctl
    private static int runStateOf(int c)     { return c & ~CAPACITY; } //从ctl里解析状态码
    private static int workerCountOf(int c)  { return c & CAPACITY; }  //从ctl里解析workerCount
    private static int ctlOf(int rs, int wc) { return rs | wc; }       //合并状态和workerCount给ctl
